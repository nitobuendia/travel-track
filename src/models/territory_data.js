...
const visitedTerritories = visitedTerritoriesCache ? JSON.parse(visitedTerritoriesCache) : {}
...
class WorldTerritoryHandler {
  get(territories, key) {
    ...
    if (key === 'visitedPercentage')
      return Math.round((100 * Object.keys(territories).length) / territoriesSet.size)
...
const visitedTerritoriesProxy = new Proxy(visitedTerritories, visitedTerritoriesHandler)
